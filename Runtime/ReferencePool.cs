...
namespace Entities
{
    ...
    public static class ReferencePool
    {
        ...
        private static object InternalSpawnInstance(string typeName, params object[] args)
        {
            ...
            {
                result = provider.Spawn(typeName);
            }
...
#endif
        private readonly Dictionary<string, int> m_Pool = new Dictionary<string, int>();
