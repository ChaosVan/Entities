...
namespace Entities
{
    public class EntityDebugger : SingletonBehaviour<EntityDebugger>
    {
        ...
        protected override void OnInitialized()
        {
            ...
            EntityManager.OnEntityGameObjectBind += OnEntityGameObjectBind;
            EntityManager.OnEntityGameObjectUnbind += OnEntityGameObjectUnbind;
        ...
        void OnEntityGameObjectBind(GameObject go, Entity entity)
        {
            GameObjectEntities.Add(go, entity);
        }

        void OnEntityGameObjectUnbind(GameObject gameObject)
        {
